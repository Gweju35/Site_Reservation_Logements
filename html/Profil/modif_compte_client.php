...
try {
    ...
    $sql = "SELECT * FROM alhaiz_breizh._client WHERE compte_id = :user_id";
...
<head>
    ...
    <link rel="stylesheet" href="../assets/pages_css/modifier_compte_client.css">
...
<body>
    ...
    <main>
        ...
        <form action="../Profil/traitement_modif_compte_client.php" method="post" enctype="multipart/form-data">
            ...
            <div>
                <div class="champ_inscription2">
                    ...
                    <input type="text" id="compte_nom" name="compte_nom" value=<?php echo $compte['compte_nom']; ?> readonly>
                    <hr>
                    <label for="compte_prenom">Prénom :</label>
                    <input type="text" id="compte_prenom" name="compte_prenom" value=<?php echo $compte['compte_prenom']; ?> readonly>
                </div>
            </div>

            <!--Date de naissance-->
            <div class="champ_inscription2">
                <label for="compte_date_naissance">Date de naissance :</label>
                <input type="date" id="compte_date_naissance" name="compte_date_naissance" value=<?php echo $compte['compte_date_naissance']; ?> readonly>
            </div>
            ...
            <div>
                <div class="champ_inscription3">
                    <?php
                    $facturation = explode(", ", $compte['client_adresse_facturation']);
                    ?>
                    <label for="adresse_facturation">Adresse de facturation * :</label>
                    <input type="text" id="adresse_facturation" name="adresse_facturation" value="<?php echo $facturation[0]; ?>" maxlength="55" placeholder="Adresse" required>
                    <hr>
                    <label for="ville_facturation">Ville * :</label>
                    <input type="text" id="ville_facturation" name="ville_facturation" value="<?php echo $facturation[1]; ?>" maxlength="40" placeholder="Ville" required>
                    <hr>
                    <label for="code_postal_facturation" id="label_code_postal_facturation">Code postal * :</label>
                    <input type="text" id="code_postal_facturation" name="code_postal_facturation" value="<?php echo $facturation[2]; ?>" placeholder="Code postal" required>
                </div>
            </div>
            ...
            <div class="champ_inscription">
                ...
                <input type="email" id="compte_email" name="compte_email" required value="<?php echo $compte['compte_email']; ?>" maxlength="50">
            </div>
            ...
            <div class="champ_inscription" id="photo_de_profil">
                ...
                <label for="compte_photo_profil_new">Photo de profil (PNG, JPG ou JPEG uniquement) :</label>
                <div class="prev_image">
                    <input class="champs_fichiers" type="file" name="compte_photo_profil_new" id="compte_photo_profil_new" accept=".jpg, .jpeg, .png"><br>
                    <img id="previewImage" src="#" alt="Aperçu de l'image" style="display:none; max-width: 100%; max-height: 100px;">
                    <input type="hidden" name="compte_photo_profil_old" id="compte_photo_profil_old" value="<?php echo $_SESSION['user_photo_profil'] ?> ">
                </div>
            </div>
            <script>
                document.getElementById('compte_photo_profil_new').addEventListener('change', function(event) {
        ...
        <script>
            ...
            function submitForm() {
                ...
                if (!code_fact()) {
                    alert("Votre code postal de facturation n'est pas valide");
                    return;
                }
                if (!mail()) {
